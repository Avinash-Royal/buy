...
/**
 * Created by GAvinash on 8/1/2017.
 */
...
public class CircleDisplay extends View {
    ...
    private float mValueWidthPercent = 30f;
    ...
    private Paint mArcPaint, mArcPaintoutersmall, mArcPainttransparent;
    ...
    private void init() {
        ...
        mArcPaintoutersmall = new Paint(Paint.ANTI_ALIAS_FLAG);
        mArcPaintoutersmall.setStyle(Paint.Style.FILL_AND_STROKE);
        mArcPaintoutersmall.setColor(getResources().getColor(R.color.circle_text));

        mArcPainttransparent = new Paint(Paint.ANTI_ALIAS_FLAG);
        mArcPainttransparent.setStyle(Paint.Style.FILL_AND_STROKE);
        mArcPainttransparent.setColor(Color.TRANSPARENT);
        ...
        mTextPaint.setColor(getResources().getColor(R.color.circle_text));
...
//        mGestureDetector = new GestureDetector(getContext(), this);
    ...
    private void drawWholeCircle(Canvas c) {
        ...
        c.drawCircle(getWidth() / 2, getHeight() / 2, r, mArcPainttransparent);
    }
    ...
    private void drawValue(Canvas c) {
        ...
        mArcPaintoutersmall.setAlpha(255);

        float angle = mAngle * mPhase;

        c.drawArc(mCircleBox, mStartAngle, angle, true, mArcPaintoutersmall);
    ...
    private void setupBox() {
        ...
        mCircleBox = new RectF(width / 2 - diameter / 4, height /2 - diameter / 4, width / 2
                + diameter / 4, height / 2 + diameter / 4);
    }
    ...
    public void setColorArc(int color) {
        mArcPaintoutersmall.setColor(color);
    }
