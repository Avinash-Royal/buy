...
import com.septems.avinash.ngrid.OrderForm.fragment.MyOrderFragment;
import com.septems.avinash.ngrid.R;


public class OrderPost extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.order_post, container, false);
        ...
        view.findViewById(R.id.fab_new_post2).setOnClickListener(new View.OnClickListener() {
            @Override
...
//                startActivity(new Intent(getActivity(), NewAssignmentPost.class));
    ...
    public void presentActivity(View view) {
        ...
        Intent intent = new Intent(getActivity(), NewOrderPost.class);
        intent.putExtra(NewOrderPost.EXTRA_CIRCULAR_REVEAL_X, revealX);
        intent.putExtra(NewOrderPost.EXTRA_CIRCULAR_REVEAL_Y, revealY);
