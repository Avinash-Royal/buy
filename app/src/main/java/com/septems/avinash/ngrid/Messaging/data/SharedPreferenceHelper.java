package com.septems.avinash.ngrid.Messaging.data;
...
public class SharedPreferenceHelper {
    ...
    private static String SHARE_KEY_signin = "signin";
    ...
    public void saveUserInfo(User user) {
        ...
        editor.putString(SHARE_KEY_signin, StaticConfig.signin);
        editor.apply();
    }
